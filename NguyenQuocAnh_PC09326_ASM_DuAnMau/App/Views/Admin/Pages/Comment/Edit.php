                            ...
                            <form class="form-horizontal" action="/admin/comments/<?= $data['id'] ?>" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="text" class="form-control" id="content" placeholder="Nhập tên bình luận..." name="content" required> -->
                                        <textarea disabled class="form-control" id="content" name="content" rows="3"><?= $data['content'] ?></textarea>
                                    </div>
                                    <div class="form-group">
